          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                Stay focused, achieve more. The ultimate productivity app designed to help you maintain focus and accomplish your goals.
              </p>
              <div className="flex space-x-4">
          ...
          <div className="border-t border-slate-200 dark:border-slate-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 px-4">
              <div className="flex items-center space-x-4 text-sm text-slate-600 dark:text-slate-400">
                <span>© {new Date().getFullYear()} Focusly. All rights reserved.</span>
                <span>•</span>
